...
void TotalArray(unsigned long long A[100],unsigned long long B[100],unsigned long long C[100], int t, int w){
	int e;
...
//	printf("mang a va b sau khi cong la ");
	for( int i=t-1;i>=0;i--){
        printf("%llu ", C[i]);	 
	}
	printf("\n");
...
int main() {
    int w = 8;
    unsigned long long p = 2147483647, a = 2147483646 , b = 2147483643, A[100], B[100], C[100], P[100], c[100];
//    printf("Nhap vao p ");
//    scanf("%llu", &p);
//    printf("Nhap vao w ");
//    scanf("%d", &w);
...
//    scanf("%llu", &b);
    ...
    printf("a + b = ");TotalArray(A, B, C, t, w);
    if(check(P, C, t)){
